...
RUN git clone https://github.com/luizbills/gitpod-wordpress /home/gitpod/gitpod-wordpress && \
    cat /home/gitpod/gitpod-wordpress/conf/.bashrc.sh >> /home/gitpod/.bashrc && \
    . /home/gitpod/.bashrc && \
...
### Install Apache2 ###    
RUN apt-get remove --purge apache2 apache2-data apache2-utils && \ 
    rm -rf /etc/apache2 && \
